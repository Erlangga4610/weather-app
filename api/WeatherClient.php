...
class WeatherClient {
	...
	private function httpGetJson(string $url): array {
		...
		if ($data === null) {
			return ['_error' => 'Gagal parse JSON', '_status' => $code, '_raw' => $body];
		}
	...
	public function getForecast(string $q, int $days = 3, string $aqi = 'no', string $alerts = 'no'): array {
		if (!WEATHER_API_KEY || WEATHER_API_KEY === 'CHANGE_ME') {
